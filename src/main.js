...
`;
        ...
        nodeFetch(`api.telegram.org/bot${BOT_API}/sendMessage`, {
          method: "POST",
          headers: {
...
const runPuppeteer = async (url) => {
  ...
  for (const element of result) {
    ...
    let path = urlPath;
    if (!path.includes("funda.nl")) {
      path = `funda.nl${urlPath}`;
    }
